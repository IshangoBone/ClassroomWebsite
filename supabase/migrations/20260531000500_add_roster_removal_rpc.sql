...
revoke all on function public.remove_student_from_classroom(uuid, uuid) from public;
grant execute on function public.remove_student_from_classroom(uuid, uuid) to authenticated;
